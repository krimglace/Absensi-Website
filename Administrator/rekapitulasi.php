	...
	<div class="container-fluid">
		<div class="section-header m-3">
			<div class="page-header alert alert-primary text-dark p-2 m-2">
				<h5>
					<b>
						<i class="fas fa-chalkboard-teacher" style="margin-left: 25px"></i>
		...
		<div class="section-main">
			<div class="search" style="margin-right: 10px">
				...
				<div class="float-start col-md-2">
					<button id="export" name="export" class="btn btn-warning">
...
<script type="text/javascript">
	$(document).ready(function(){
		$('.data-table').load('php/datatable-rekapitulasi.php');
		$('#search').click(function(){
			...
			$.ajax({
				type: 'POST',
	            url: "php/datatable-rekapitulasi.php",
