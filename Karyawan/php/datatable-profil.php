...
<table class="table table-hover table-striped table-border">
	...
	<tr>
		...
		<td><?= $result['email'] ?></td>
		<td><h5><a href="" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $result['id_karyawan'] ?>"><i class="fas fa-edit"></i></a></h5></td>
	</tr>
</table>
<!-- Modal Edit -->
<div class="modal fade" id="exampleModal<?= $result['id_karyawan'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  	<div class="modal-dialog">
    	<div class="modal-content">
    		<?php

    			$query = mysqli_query($conn, "SELECT * FROM user as us JOIN karyawan as ad ON us.rfid = ad.rfid WHERE ad.id_karyawan = '".$result['id_karyawan']."'");
